...
axs[0, 3].plot(data20[:, 0], data20[:, 50])
axs[0, 3].plot(data20[:, 0], data20[:, 40])
axs[0, 3].plot(data20[:, 0], data20[:, 30])
axs[0, 3].plot(data20[:, 0], data20[:, 20])
axs[0, 3].set_title('20')
axs[1, 0].plot(data21[:, 0], data21[:, 50])
axs[1, 0].plot(data21[:, 0], data21[:, 40])
axs[1, 0].plot(data21[:, 0], data21[:, 30])
axs[1, 0].plot(data21[:, 0], data21[:, 20])
axs[1, 0].set_title('21')
axs[1, 1].plot(data22[:, 0], data22[:, 50])
axs[1, 1].plot(data22[:, 0], data22[:, 40])
axs[1, 1].plot(data22[:, 0], data22[:, 30])
axs[1, 1].plot(data22[:, 0], data22[:, 20])
axs[1, 1].set_title('22')
axs[1, 2].plot(data23[:, 0], data23[:, 50])
axs[1, 2].plot(data23[:, 0], data23[:, 40])
axs[1, 2].plot(data23[:, 0], data23[:, 30])
axs[1, 2].plot(data23[:, 0], data23[:, 20])
axs[1, 2].set_title('23')
